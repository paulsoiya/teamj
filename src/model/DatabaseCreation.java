...
public class DatabaseCreation {
	...
	/*
	 * Create the professional database Create Tables Player, Team, GameLog, and Stats
	 */
	public void createProfessionalDatabase() {
		...
		try {
			...
			sql = "CREATE TABLE Team(" + "TeamID         TEXT    PRIMARY KEY,"
					+ "TeamName       TEXT," + "Logo           TEXT,"
					+ "PrimaryColor   TEXT," + "SecondaryColor TEXT);";
			stmt.executeUpdate(sql);
			
			sql = "CREATE TABLE Player(" + "PlayerID       TEXT    PRIMARY KEY,"
					+ "PlayerName     TEXT," + "Team           TEXT,"
					+ "Position       TEXT," + "Picture        TEXT,"
					+ "Height         INT," + "Weight         INT,"
					+ "BirthDate      TEXT," + "College        TEXT,"
					+ "Number         INT,"
					+ "FOREIGN KEY(Team) REFERENCES Team(TeamID));";
			stmt.executeUpdate(sql);
			
			sql = "CREATE TABLE GameLog(" + "GameID         TEXT    PRIMARY KEY,"
					+ "Date           TEXT," + "Team           TEXT,"
			...
			sql = "CREATE TABLE Stats("
					...
					+ "GameID         TEXT," + "PlayerID       TEXT,"
					+ "Yards            INT," + "TDs            INT,"
					+ "Att            INT," + "Average        REAL,"
	...
	public void createIndividualDatabase() {
		...
		try {
			...
			sql = "CREATE TABLE Sport("
					...
					+ "UserID        INT," + "SportName     TEXT,"
					+ "Position      TEXT," + "FavoriteTeam  TEXT,"
